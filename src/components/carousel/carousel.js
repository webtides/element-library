 ...
 */
export default class Carousel extends TemplateElement {
    #glide = null;
    #uniqueChildren = [];
    ...
    mountGlide() {
        ...
        this.#glide.on('run', () => {
            this.dispatch(CarouselEvents.CAROUSEL_RUN, this.#glide.index);
...
export function define() {
    defineElement('el-carousel', Carousel);
}

export { html, defineElement, CarouselEvents };
