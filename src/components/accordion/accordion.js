...
import Events from './accordion.events.js';
 ...
 *
 * @fires {CustomEvent<{ open: boolean }>} AccordionToggle - Fired when the accordion is
...
export function define() {
    defineElement('el-accordion', Accordion);
}
