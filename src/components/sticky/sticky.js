...
import style from './sticky.style.js';
 ...
 * from CSS (e.g. `el-sticky:state(sticky):state(up) { … }`). Publishes the host's
 ...
 */
export default class Sticky extends StyledElement {
    /** @private */
    height = 0;
    /** @private */
    lastScrollTop = 0;
...
export function define() {
    defineElement('el-sticky', Sticky);
}
